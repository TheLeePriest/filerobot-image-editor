  ...
  function ImageManipulator() {
    ...
    _defineProperty(_assertThisInitialized(_this), "saveImage", function () {
      ...
      if (!processWithCloudService) {
        ...
        if (nameLength <= 1) {
          name = "".concat(splittedName.join('.'), "-version-").concat(((0, _uuid.v4)() || '').slice(0, 6));
        } else {
          name = [splittedName.slice(0, nameLength - 1).join('.'), '-version-', ((0, _uuid.v4)() || '').slice(0, 6), '.', splittedName[nameLength - 1]].join('');
        }
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(INITIAL_PARAMS, "INITIAL_PARAMS", "/Users/lee/Sites/filerobot-image-editor/projects/react/components/Preview/ImageManipulator.js");

  __REACT_HOT_LOADER__.register(ImageManipulator, "ImageManipulator", "/Users/lee/Sites/filerobot-image-editor/projects/react/components/Preview/ImageManipulator.js");
}();
